...
$config = array(
	...
	'smtp_user'    => (get_settings('smtp_user') != null) ? trim(get_settings('smtp_user')) : 'komalkhalasi.13@gmail.com',
	'smtp_pass'    => (get_settings('smtp_password') != null) ? trim(get_settings('smtp_password')) : '8469952279',
